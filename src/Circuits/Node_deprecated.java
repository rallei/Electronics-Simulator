...
public class Node_deprecated {
     ...
     *
     */
    Node_deprecated[] nodeIn; //node connection IN; list of everything connected to the input of thisssssssssssss
    Node_deprecated[] nodeOut; //node connection OUT
